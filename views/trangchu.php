<?php 
	// bien data la ten goi ben controller.php
	$slide = $data['slide'];
 ?>
	<!-- banner -->
	  ...
	  <div class="carousel-inner" role="listbox">
		  <?php 
		   ...
		   <div class="item<?=$i==1?' active':''?>">
		     <img src="public/images/slide/<?php echo $slide[$i]->Hinh ?>" alt="Chania">
	...
	<div class="banner-bottom">
		<div class="container">
			<div class="move-text">
				...
				<div class="marquee">
					<div class="marquee1"><a class="breaking" href="public/single.html">A 5-year-old boy who recently returned to the U.S from Ebola-stricken West Africa is under observation after experiencing a fever.</a></div>
					<div class="marquee2"><a class="breaking" href="public/single.html">The surprisingly successful president of the Philippines and peacemaking in the Philippines: Shaking it all up.</a></div>
